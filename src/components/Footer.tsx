            ...
            <div>
              ...
              <ul className="space-y-4">
                <li className="flex items-start gap-3">
                  ...
                  <span className="text-white/90">{settings?.address || 'Endereço não informado'}</span>
                </li>
                <li className="flex items-center gap-3">
                  <Phone className="shrink-0 text-yellow-400" />
                  <span className="text-white/90">{settings?.phone || 'Telefone não informado'}</span>
                </li>
                <li className="flex items-center gap-3">
                  <Mail className="shrink-0 text-yellow-400" />
                  <span className="text-white/90">{settings?.email || 'Email não informado'}</span>
                </li>
              </ul>
            </div>
