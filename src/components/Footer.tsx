...
export function Footer() {
  ...
  return (
    <footer className="bg-emerald-800 text-white/90 pt-16 pb-8">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="border-t border-emerald-700 pt-8 text-center text-sm flex flex-col items-center gap-2">
          <p>{settings.footerText}</p>
          <a href="#admin" className="text-emerald-900 hover:text-white text-xs">Acesso Administrativo</a>
        </div>
      </div>
    </footer>
  );
